...
/*
  ...
  14. Search Box Popup
  15. Counter Up
  16. Shape Mockupsass --watch assets/scss/style.scss:assets/css/style.css
...
/*----------- 00. Right Click Disable ----------*/
 ...
 $(document).ready(function(){
            ...
            // Prize Configuration
            const prizes = [
                { text: "Free Trial", color: "#FF6B6B", fullText: "Free Trial Class" },
                { text: "Free Assessment", color: "#4ECDC4", fullText: "Free Creative Assessment" },
                { text: "Clay Kit", color: "#FFD166", fullText: "Free Mini Clay Kit" },
                { text: "₹500 Off", color: "#06D6A0", fullText: "₹500 Off on Course Fee" },
                { text: "10% Off", color: "#118AB2", fullText: "10% Off on Any Course" },
                { text: "15% Off", color: "#073B4C", fullText: "15% Off on Full Batch" },
                { text: "Workshop", color: "#7209B7", fullText: "Free Workshop Pass" },
                { text: "₹300 + Gift", color: "#F72585", fullText: "₹300 Off + Free Goodie Bag" },
                { text: "Parent-Child", color: "#3A86FF", fullText: "Parent-Child Session" }
            ];
            ...
            function showWinner() {
                ...
                prizeText.textContent = `You won: ${prize.fullText}`;
