...
// const API_BASE = 'https://backend.lilsculpr.com/api/special-course';
  ...
  const WORKSHOP_NAME = 'Kids Fruit & Vegetable Clay Mirror Workshop';
  const WORKSHOP_PRICE = 750;
  const WORKSHOP_DATE = '2026-08-02';
  ...
  async function checkSlotAvailability() {
    ...
    try {
      const params = new URLSearchParams({
        ...
        batch: 'Kids Fruit & Vegetable Clay Mirror Workshop ⏰ 11:00 AM - 1:00 PM',
        date: WORKSHOP_DATE
      });
  ...
  function openRazorpay(orderData, registrationId) {
    return new Promise((resolve, reject) => {
      const options = {
        ...
        description: 'Kids Fruit & Vegetable Clay Mirror Workshop',
  ...
  console.log('✅ Kids Fruit & Vegetable Clay Mirror Workshop registration form initialized');
  checkSlotAvailability();
})();
